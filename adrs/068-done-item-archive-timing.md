...
**Positive:**
- Board bloat and the per-poll GraphQL cost of fetching it now have an actual upper bound: a Done item is removed from the board 24h (default, configurable) after its work is visibly complete.
