...
<section class="quickstart" id="quickstart">
  <div class="container">
    ...
    <p class="section-subtitle">
      Fabrik runs as a local CLI. You need Go, Claude Code, and a GitHub token.
    </p>
    ...
    <div class="quickstart-steps">
      <div>
        ...
        <div class="step">
          ...
          <div class="step-content">
            <div class="step-title">Build &amp; initialize</div>
            <div class="step-desc">Clone the repo, build, and run <code>fabrik init</code> to scaffold stage configs into your project.</div>
          </div>
        </div>
        <div class="step">
      ...
      <div class="code-block">
        ...
        <pre>
<span style="color:#56d364"># 1. Clone and build</span>
...
<section id="links">
  <div class="container">
    ...
    <div class="links-grid">
      ...
      <a href="https://github.com/tenaciousvc/fabrik/blob/main/docs/USER_GUIDE.md" class="link-card" target="_blank" rel="noopener">
        <span class="link-icon">📖</span>
        <div>
      ...
      <a href="https://github.com/tenaciousvc/fabrik/blob/main/README.md" class="link-card" target="_blank" rel="noopener">
        <span class="link-icon">📄</span>
        <div>
