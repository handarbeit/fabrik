...
Adds `FABRIK_NO_WORK_NEEDED` marker — any stage can short-circuit the pipeline straight to Done when an issue needs no implementation, instead of failing PR creation with "no commits between main and branch".
