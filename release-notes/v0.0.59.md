...
Implement stage no longer silently marks itself complete when draft PR creation fails — a long-standing flake that left Review waiting on PRs that didn't exist. Plus v0.0.58 documentation.
