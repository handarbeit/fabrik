...
Adds `@mention` notifications on awaiting-input comments (for mobile push delivery via GitHub) and a SIGHUP-driven in-place self-restart. Completes the org migration to `handarbeit`.
