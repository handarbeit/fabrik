...
Targeted bugfix release: closes a latent regression from the v0.0.57 GraphQL-cost-reduction work. v0.0.59 made PR-creation failures visible; this release fixes the underlying cause of the most common one — items first seen via the probe ended up with empty titles, which triggered HTTP 422 on PR creation.
