...
// treated as non-human rather than silently defeating a pause). Used at the
// paused / awaiting-input resume-decision sites so bot chatter cannot
// silently defeat an operator-applied pause (#1083).
//
