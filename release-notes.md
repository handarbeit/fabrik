...
- **Auto-upgrade now fetches from shadoworg/fabrik** — The upgrade check was still pointing at the private repo. Now fetches releases from the public `shadoworg/fabrik` repo where binaries are published.

## Improvements

- **Documentation site at fabrik.shadoworg.dev** — Public docs are now served from a custom domain. All links updated to point at the public `shadoworg/fabrik` repo for releases, issues, and discussions.
