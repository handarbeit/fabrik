...
The `fabrikOwner` constant was hardcoded to `arbeithand` instead of `handarbeit`. This caused the upgrade check to look in the wrong repository for new releases. Fixed to use the correct organization.
