...
- Release download command in the `cut-release` skill and all published release notes now uses the canonical auto-detect form from the marketing site (correct repo `handarbeit/fabrik`, auto-detects OS and architecture via `uname`).
