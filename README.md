...
It is not installed by `fabrik init`. See [Entwurf Plugin](docs/USER_GUIDE.md#entwurf-plugin) in the User Guide for the full skill list, installation options, and attribution.
...
| Stage | Purpose |
|-------|---------|
| **Backlog** | Parking lot; declared `unmanaged: true` (no processing) |
