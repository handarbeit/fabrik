...
Fabrik is proprietary software. Collaborators are permitted to read and run the software at no cost. Modification, distribution, copying, or any other use beyond reading and running requires express written permission from Fabrik Contributors. See the [LICENSE](LICENSE) file for full terms.
