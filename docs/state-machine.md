...
| `fabrik:nondefault-base-pr-noted` | Informational | No — does not gate dispatch or suppress anything; marks that the one-time non-default-base linkage notice (§6.20, ADR-1649) has already been posted (or attempted) for this item |
...
### 6.20 Non-Default-Base Linkage Notice (#1649)
