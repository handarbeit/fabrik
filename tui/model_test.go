...
func TestView_AfterWindowSize(t *testing.T) {
	m := New(30, ProjectInfo{BoardTitle: "Acme PM", CWD: "~/myproject"}, nil, nil, 0, false)
	m.width = 80
	m.height = 24
...
func TestHelpPanelToggle(t *testing.T) {
	...
	m2 := New(30, ProjectInfo{}, nil, nil, 0, false)
	m2.width = 80
	m2.height = 24
	m2.detailPanel = true
...
func TestUpdate_WKey_SendsOnWakeCh(t *testing.T) {
	...
	m := New(30, ProjectInfo{}, nil, wakeCh, 0, false)
	m.width = 80
	m.height = 24
...
func TestUpdate_UKey_WhenStale_SetsConfirmUpgrade(t *testing.T) {
	m := New(30, ProjectInfo{}, nil, nil, 3, false)
...
func TestUpdate_New_WithSkillsStaleCount(t *testing.T) {
	m := New(30, ProjectInfo{}, nil, nil, 5, false)
